...
const savedLang = sessionStorage.getItem('selectedLanguage') || 'en';
    i18next.init({
      ...
      translation: {
        ...
        //-------
        "followTitle": "ABOUT Girl Rules Series",
        "description": "\"Girl Rules Series\" is GMMTV's sapphire series, starring by Namtan Tipnaree, Film Rachanun, Milk Pansa, Love Pattranite, View Benyapa & Mim Rattanawadee.",
        "description2": "The series is directed by Jojo Tichakorn.",
        "watch": "Watch the Official Pilot",
        "maincast": "MAIN CAST",
        "title2": "Related to Girl Rules Series"
      }
    },
    zh: {
      translation: {
        ...
        //-------
        "followTitle": "关于《女生规则：禁爱游戏》",
        "description": "\"女生规则：禁爱游戏\" 是GMMTV 2025阵容中的剧集之一, 由 Namtan Tipnaree, Film Rachanun, Milk Pansa, Love Pattranite, View Benyapa 以及 Mim Rattanawadee主演",
        "description2": "该剧集由Jojo Tichakorn执导",
        "watch": "观看先行预告片",
        "maincast": "主要演员",
        "title2": "与《Girl Rules》相关的"
    ...
    ja: {
      translation: {
        ...
        //-------
        "followTitle": "『Girl Rules Series』について",
        "description": "「Girl Rules Series」は、GMMTVが手掛けるオリジナルシリーズであり、Namtan Tipnaree、 Film Rachanun、Milk Pansa、Love Pattranite、View Benyapa、Mim Rattanawadeeが主演を務めています",
        "description2": "監督はJojo Tichakornが担当しています",
        "watch": "公式パイロット版予告を視聴する",
        "maincast": "メインキャスト",
        "title2": "『Girl Rules Series』関連"
      }
    },
    tl: {
      translation: {
        ...
        //-------
        "followTitle": "ABOUT Girl Rules Series",
        "description": "Ang \"Girl Rules Series\" ay isang serye tungkol sa mga sapphic mula sa GMMTV na pinagbibidahan nina Namtan Tipnaree, Film Rachanun, Milk Pansa, Love Pattranite, View Benyapa & Mim Rattanawadee.",
        "description2": "Ang serye ay idinirek ni Jojo Tichakorn.",
        "watch": "Panoorin ang Official Pilot",
        "maincast": "MAIN CAST",
        "title2": "Kaugnay sa Girl Rules Series"
      }
    },
    ita: {
          translation: {
            ...
            //-------
            "followTitle": "RIGUARDO LA SERIE \"GIRL RULES\",
            "description": "La serie \"Girl rules\" e' una serie Gl di GMMTV,con protagoniste Namtan Tipnaree, Film Rachanun, Milk Pansa, Love Pattranite, View Benyapa & Mim Rattanawadee.",
            "description2": "La serie è diretta da Jojo Tichakorn.",
            "watch": "Guarda qui il pilot ufficiale ",
            "maincast": "CAST PRINCIPALE ",
            "title2": "riguardo la serie \"Girl Rules\""
          }
        }
  }
}, function(err, t) {
