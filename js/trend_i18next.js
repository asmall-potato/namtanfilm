    ...
    i18next.init({
      ...
      en: {
        translation: {
          ...
          //-------
          "followTitle": "Trend X Highest Rank OF NAMTANFILM",
          "description": "Trend X Highest Rank (Year 2024)",
          "description2": "Trend X Highest Rank (Year 2025)",
      ...
      zh: {
        translation: {
          ...
          //-------
          "followTitle": "NAMTANFILM的趋势 × 最高排名",
          "description": "趋势 × 最高排名（2024年）",
          "description2": "趋势 × 最高排名（2025年）",
      ...
      ja: {
        translation: {
          ...
          //-------
          "followTitle": "NAMTANFILM トレンドX最高順位記録",
          "description": "トレンドX最高順位（2024年）",
          "description2": "トレンドX最高順位（2025年）",
        }
      },
      tl: {
        translation: {
          ...
          //-------
          "followTitle": "Pinakamataas na Trend sa X nina NAMTANFILM",
          "description": "Pinakamataas na Trend sa X (2024)",
          "description2": "Pinakamataas na Trend sa X (2025)",
        }
      }
    }
  }, function(err, t) {
