      ...
      resources: {
        en: {
          translation: {
            ...
            //-------
            "followTitle": "Brands",
            "description": "Luxury, Electronics, Jewelry, Cosmetic, Skincare, Hair care, Food brands collaborate with Namtan Tipnaree and Film Rachanun",
            "year": "(Year 2024)"
            }
        },
        zh: {
          translation: {
            ...
            //-------
            "followTitle": "品牌",
            "description": "奢侈品、电子产品、珠宝、化妆品、护肤品、护发产品、食品品牌等等与Namtan Tipnaree 和 Film Rachanun合作",
            "year": "(2024年)"
          }
        },
        ja: {
          translation: {
            ...
            //-------
            "followTitle": "ブランド",
            "description": "Namtan Tipnaree＆Film Rachanunがコラボレーションしたブランド一覧 </br>種類：高級ブランド品、電子製品、ジュエリー、コスメ用品、スキンケア用品、ヘアケア用品、食品 など",
            "year": "(2024年)"
          }
        },
        tl: {
